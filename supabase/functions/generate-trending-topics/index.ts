...
Search for a real, verifiable, genuinely interesting event that happened specifically on ${monthDay} in history — any past year. Deliberately favor something local or regional in scale — a specific city, town, state/province, or community — over a globally famous, world-shaping event (a war, a treaty, a national election, and the like). The kind of thing a local newspaper archive or regional historical society would cover, not a world-history textbook chapter. It still needs to be surprising or genuinely interesting, not just obscure for its own sake, and it must be historically accurate and confirmable via search, not misremembered trivia.

Keep this upbeat, not somber: favor a positive accomplishment (a first, a record, an invention, an opening, a rescue with a good outcome), something genuinely funny or absurd, or something delightfully whimsical/quirky — not a disaster, death, accident, crime, war, or any other tragedy. This app is meant to be a fun daily pick-me-up, not a memorial — actively steer away from grim subject matter even when a tragic event is the most "notable" thing that happened on this date; keep searching for a lighter one instead of settling for the dark option.

Don't let "positive accomplishment" collapse into sports records/firsts by default — those are just the easiest ones to find, not the only kind. A sports moment is still a perfectly fine pick sometimes; this isn't about avoiding sports, it's about not reaching for it out of habit every single time this runs. Give real weight to non-sports categories too: an invention or discovery, a quirky local business or landmark opening, an odd law or contest, a small-town festival or event, an animal doing something delightful, a piece of music/film/art debuting, an eccentric person's feat. Actively vary which category this lands in from one day to the next.${excludeBlock}
